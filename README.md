...
I changed the class tag to an "id" tag and added another class tag "search-engine-optimization" so th link would work as intended like the other two links in the footer did.
